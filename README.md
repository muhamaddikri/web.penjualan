...
10. Siap disambungkan ke Supabase — struktur database + kode CRUD sudah disediakan (termasuk kolom waktu & nama kasir).
11. Manajemen stok otomatis — stok berkurang otomatis setiap transaksi baru.
12. Notifikasi toast — konfirmasi simpan & peringatan stok tipis.
13. Manajemen Akun Kasir — Owner bisa membuat akun kasir baru dari menu Pengaturan.
